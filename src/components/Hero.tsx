      ...
      <div className="relative z-10 text-center max-w-7xl mx-auto">
        <div className="space-y-8 animate-fade-in">
          ...
          <div className="space-y-4">
            <h1 className="text-2xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-gray-900 dark:text-white leading-tight sm:leading-tight leading-snug mb-2 sm:mb-0">
          ...
          {/* Description */}
          <p className="text-base sm:text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto leading-relaxed animate-fade-in delay-700 px-2 sm:px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4 animate-fade-in delay-1000">
            <Button 
              ...
              className="group w-full sm:w-auto px-3 sm:px-10 py-3 sm:py-6 text-base sm:text-xl font-extrabold rounded-xl sm:rounded-2xl shadow-md sm:shadow-xl border-2 border-transparent bg-white/60 dark:bg-slate-900/60 backdrop-blur-md relative overflow-hidden focus:outline-none focus-visible:ring-4 focus-visible:ring-emerald-400/60 transition-all duration-200
                before:content-[''] before:absolute before:inset-0 before:rounded-xl before:sm:rounded-2xl before:border-2 before:border-gradient-to-r before:from-emerald-400 before:to-cyan-400 before:opacity-80 before:pointer-events-none
                active:scale-95"
              style={{ letterSpacing: '0.03em', boxShadow: '0 2px 12px 0 rgba(16, 185, 129, 0.12), 0 1.5px 6px 0 rgba(20, 184, 166, 0.14) inset' }}
            >
              <span className="relative z-10 bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent drop-shadow-lg">
                Book Free Consultation
              </span>
              <ArrowRight className="ml-3 h-5 w-5 sm:h-7 sm:w-7 group-hover:translate-x-1 transition-transform duration-300 relative z-10" />
            </Button>
