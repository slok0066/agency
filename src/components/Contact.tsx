        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="space-y-6 animate-slide-in-right">
            {contactInfo.map((contact, index) => (
              <div key={index} className={`group bg-white/80 dark:bg-white/5 backdrop-blur-sm rounded-3xl p-6 border border-gray-200 dark:border-white/10 shadow-lg hover:shadow-xl transition-all duration-500 hover:transform hover:scale-105 animate-fade-in`} style={{animationDelay: `${index * 200}ms`}}>
