  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 dark:text-gray-300">Last Updated: June 20, 2025</p>
      </div>

      <div className="prose dark:prose-invert max-w-none">
        <div className="bg-white dark:bg-gray-900/50 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-gray-200 dark:border-gray-800">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-6">1. Information We Collect</h2>
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-6">2. How We Use Your Information</h2>
          <p className="text-gray-700 dark:text-gray-300 mb-6">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-6">3. Information Sharing</h2>
          <p className="text-gray-700 dark:text-gray-300 mb-6">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-6">4. Data Security</h2>
          <p className="text-gray-700 dark:text-gray-300 mb-6">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-6">5. Your Choices</h2>
          <p className="text-gray-700 dark:text-gray-300 mb-6">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-6">6. Changes to This Policy</h2>
          <p className="text-gray-700 dark:text-gray-300 mb-6">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-6">7. Contact Us</h2>
          <p className="text-gray-700 dark:text-gray-300">
            If you have any questions about this Privacy Policy, please contact us at:
          </p>
          <div className="mt-4 space-y-2">
            <p className="text-gray-700 dark:text-gray-300">Email: <a href="mailto:thinkbuild8@gmail.com" className="text-emerald-600 dark:text-emerald-400 hover:underline">thinkbuild8@gmail.com</a></p>
            <p className="text-gray-700 dark:text-gray-300">Phone: <a href="tel:9204527554" className="text-emerald-600 dark:text-emerald-400 hover:underline">+91 92045 27554</a></p>
          </div>
        </div>
      </div>
    </div>
